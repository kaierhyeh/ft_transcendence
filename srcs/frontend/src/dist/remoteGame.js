...
export default function initRemoteGame() {
...
function createRemoteInterface() {
    ...
    if (btn2p != null)
        btn2p.style.display = 'block';
    if (btn4p != null)
        btn4p.style.display = 'block';
    setupRemoteEvents();
}
...
// remoteGame.ts - Juste cette fonction, pas besoin d'imports ni autres fonctions
...
//(window as any).matchFound = matchFound;
//# sourceMappingURL=remoteGame.js.map